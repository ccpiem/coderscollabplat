  ...
  return (
    <div className={"flex justify-center items-center relative left-0 bottom-0 right-0 border-t-2 border-x-2 border-main backdrop-blur-sm w-full"}>
      <div className={"flex flex-col justify-center items-center"}>
        ...
        <div>
          <p>© {new Date().getFullYear()} <a href="https://www.linkedin.com/in/archit-sinha-45a5251b7/" target={"blank"} title={"Archit's LinkedIn"}>ARCHIT</a>SINHA<a href="https://www.linkedin.com/in/nitin-bhimrajka-9235151bb/?originalSubdomain=in" target={"blank"} title={"Nitin's LinkedIn"}></a>, India</p>
        </div>
