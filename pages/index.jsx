...
const Index = ({theme}) => {
  return (
    <>
      <Head>
        <title>Home | Coder's Collaboration Platform</title>
      </Head>
    <div className='flex items-center flex-col backdrop-blur-sm'>
      ...
      <div className='flex justify-around items-around p-2.5 pb-12'>
        <div className="w-4/5" data-aos="fade-up" data-aos-duration="3000">
          ...
          <p className='text-2xl sm:text-sm text-center'>Welcome to Coder's Collaboration Platform, an open community dedicated to competitive programming enthusiasts!We want to bring students who are passionate about programming and have come together to create a community for like-minded individuals to connect and collaborate.
