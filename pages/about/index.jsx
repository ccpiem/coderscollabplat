 ...
 * title of the page and a div containing information about the Coder's Collaboration Platform community.
 */
...
const Index = () => {
  return (
    <>
      <Head>
        <title>About | Coder's Collaboration Platform</title>
      </Head>
    <div className='flex justify-around items-around p-2.5 pb-12 backdrop-blur-sm'>
      <div className="w-4/5">
        ...
        <p className='text-xl sm:text-base text-center'>Welcome to Coder's Collaboration Platform, an open community dedicated to competitive programming enthusiasts! We want to bring students who are passionate about programming and have come together to create a community for like-minded individuals to connect and collaborate.
        At Coder's Collaboration Platform, we believe that programming is not just a hobby, but a way of life. Our goal is to create a community where everyone can learn from each other, grow together, and have fun while doing it. Whether you are a beginner just starting out or a seasoned pro, we welcome you to join us on this journey. <br /><br />
        ...
        We launched Coder's Collaboration Platform in May 2023, and since then, we have grown into a vibrant community with members from all over the college. We have hosted several successful contests, workshops, and webinars, and we are constantly looking for new ways to improve and serve our members better. <br /><br />


        We are excited about the future of Coder's Collaboration Platform, and we invite you to be a part of our community. Join us today and take the first step towards becoming a better programmer!</p>
      </div>
    </div>
    </>
  )
